...
func TestCreate(t *testing.T) {
	...
	t.Run("Failed to Create", func(t *testing.T) {
		...
		reqBody, _ := json.Marshal(InsertUserRequestFormat{
			Name:     "",
			Email:    "",
			Password: "",
		})
...
func TestUpdate(t *testing.T) {
	...
	t.Run("Error input Update", func(t *testing.T) {
		...
		response := UpdateUserResponseFormat{}
...
func TestGetAll(t *testing.T) {
	...
	t.Run("Success Login", func(t *testing.T) {
		...
		authController := auth.New(&MockAuthAdminLib{})
		authController.Login()(context)
	...
	t.Run("Success Login", func(t *testing.T) {
		...
		jwtTokenU = response.Data["token"].(string)
	...
	t.Run("Success Get All User", func(t *testing.T) {
		...
		response := GetAllUserResponseFormat{}
	...
	t.Run("Failed Get All User", func(t *testing.T) {
		...
		req.Header.Set("Content-Type", "application/json")
		req.Header.Set("Authorization", fmt.Sprintf("Bearer %v", jwtTokenU))
